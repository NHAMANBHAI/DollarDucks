...
const Navbar = () => {
  ...
  const dropdownItems = {
    Services: [
      {
        title: "Pro-Level Website",
        link: "/pro-level-website",
        icon: <FiTrendingUp />,
      },
      {
      ...
      },
      {
        ...
        link: "/automated-lead-management",
        icon: <FiUsers />,
      },
      {
        title: "Neighborhood SEO",
        link: "/neighborhood-seo",
        icon: <FiGlobe />,
      },
      {
        title: "SEO Power Play",
        link: "/seo-power-play",
        icon: <FiUploadCloud />,
      },
      {
        title: "Growth-Focused Add-Ons",
        link: "/growth-focused-add-ons",
        icon: <FiBriefcase />,
      },
    ],
    WhoWeServe: [
      ...
      },
      {
        ...
        link: "/professionals-experts",
        icon: <FiBriefcase />,
      },
      {
        title: "Small Business Champions",
        link: "/small-business-champions",
        icon: <FiGlobe />,
      },
    ],
    Academy: [
      ...
      },
      {
        title: (
          <>
            <s>Podcast</s>{" "}
            <span className="text-gray-500 ml-15">Coming Soon</span>
          </>
        ),
        link: "/podcast",
        icon: <FiMic />,
